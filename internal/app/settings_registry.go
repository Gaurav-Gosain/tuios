...
var settingLabels = map[string]string{
	...
	"debug.show_key_events":             "Show keys overlay",
	...
	"notifications.error_sticky":                 "Errors stay up",
	"notifications.agent.enabled":                "Agent alerts",
	"notifications.agent.notify":                 "Agent desktop notification",
	"notifications.agent.dock":                   "Agent alert in the dock",
	"notifications.agent.sound":                  "Agent alert sound",
	"notifications.agent.sound_mode":             "Agent sound mode",
	"notifications.agent.sound_cooldown_seconds": "Agent sound cooldown",
	"notifications.agent.settle_seconds":         "Agent settle time",
	"notifications.agent.suppress_focused":       "Quiet for the focused pane",
	"notifications.agent.quiet_hours":            "Agent quiet hours",
	"notifications.agent.command":                "Agent alert command",
	"notifications.agent.states.working":         "Alert on working",
	"notifications.agent.states.idle":            "Alert on idle",
	"notifications.agent.states.done":            "Alert on done",
	"notifications.agent.states.needs_input":     "Alert on needs input",
	"notifications.agent.states.errored":         "Alert on errored",
}
