...
func configFileHeader(configPath string) string {
	...
	sb.WriteString("# auto_enter_terminal_on_focus: false (Tab keeps cycling windows),\n")
	sb.WriteString("#               true (a keyboard focus command that actually moves\n")
	sb.WriteString("#               focus also enters terminal mode)\n")
