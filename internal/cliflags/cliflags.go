...
func (i *Interface) Register(fs *pflag.FlagSet) {
	...
	fs.StringVar(&i.DockbarPosition, "dockbar-position", "", "Dockbar position: bottom, top, hidden (default: from config or bottom)")
	...
	fs.StringVar(&i.WindowTitlePosition, "window-title-position", "", "Window title position: bottom, top, hidden (default: from config or bottom)")
