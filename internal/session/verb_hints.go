...
var errorCodeCatalog = []struct {
	...
	{ErrVerbNotHuman, "Only the person at an attached client may make this call, and it carried no nonce from a live attach. dismiss-attention and respond raise it."},
