	...
	verbRegistry = map[string]verbEntry{
		...
		"start-agent": {
			...
			params: []verbParam{
				...
				{Name: "cwd", Type: "string", Description: "The directory the agent starts in. Omit for the focused pane's."},
