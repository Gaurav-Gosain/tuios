...
local term = tuios.Terminal({ pty = mock_pty(), ratio = 0.5, id = "t1", focus = true, show_cursor = false })
...
local text2 = tuios.Text({ { text = "a" }, { text = "b" } })
...
local text3 = tuios.Text({ text = "single", style = { fg = "red" } })
...
local text4 = tuios.Text({ content = { "x", "y" }, show_cursor = true })
...
local col1 = tuios.Column({ { type = "text" }, { type = "text" } })
...
local row1 = tuios.Row({ { type = "text" }, { type = "text" } })
...
local stack1 = tuios.Stack({ { type = "text" }, { type = "box" } })
...
local stack2 = tuios.Stack({ children = { { type = "text" } }, ratio = 0.5, id = "s1" })
...
local pos1 =
    tuios.Positioned({ child = { type = "text" }, x = 10, y = 20, anchor = "top_left", ratio = 0.5, id = "p1" })
...
local pos2 = tuios.Positioned({ { type = "box" }, x = 5 })
...
-- Test: TextInput
local input = tuios.TextInput({ input = mock_text_input(), style = { fg = "blue" }, focus = true })
...
local box2 = tuios.Box({ { type = "row" }, border = "double" })
...
local pad2 = tuios.Padding({ { type = "column" }, all = 1 })
