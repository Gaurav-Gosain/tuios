...
--- Shared mock constructors and tuios mock setup
local M = {}
...
---Install the tuios mock module with all fields any branch needs.
---Returns the mock table so callers can override specific fields.
---@return table
function M.setup_tuios_mock()
    local mock = {
        tiling = function() end,
        ---@param opts { pty: Pty }
        ---@return table
